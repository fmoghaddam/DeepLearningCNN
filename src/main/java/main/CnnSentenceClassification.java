...
public class CnnSentenceClassification {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //String pathFirstNegativeFile = FilenameUtils.concat(DATA_PATH, "aclImdb/test/neg/test1.txt");
        ...
        INDArray featuresFirstNegative = ((CnnSentenceDataSetIterator)testIter).loadSingleSentence("He is president of England.");
        ...
        //pathFirstNegativeFile = FilenameUtils.concat(DATA_PATH, "aclImdb/test/neg/test2.txt");
        //contentsFirstNegative = FileUtils.readFileToString(new File(pathFirstNegativeFile));
        featuresFirstNegative = ((CnnSentenceDataSetIterator)testIter).loadSingleSentence("he is king of my heart.");

        predictionsFirstNegative = net.outputSingle(featuresFirstNegative);
        labels = testIter.getLabels();
